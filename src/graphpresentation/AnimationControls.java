...
public class AnimationControls {
    ...
    private void restoreSavedState() {
        ...
        frame.getPetriNetsPanel().setNullPanel(); // july 2023
        frame.getPetriNetsPanel().addGraphNet(holder.get()); // запам'ятовує неправильні значення перша-друга дуга
        frame.getPetriNetsPanel().repaint();
        holder.clear();
    }
