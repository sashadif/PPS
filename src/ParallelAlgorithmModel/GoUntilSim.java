...
public class GoUntilSim extends PetriSim {
    ...
    public GoUntilSim(int threadComplexity) throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay {
        super(NetLibrary.CreateNetGoUntil(threadComplexity));
        this.threadComplexity = threadComplexity;
    }
     public GoUntilSim(int cores, int threadComplexity) throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay {
