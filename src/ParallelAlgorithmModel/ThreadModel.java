...
public class ThreadModel {
    ...
    public ThreadModel(double tsim, int numEvents, int maxBuffer) throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay {
        prev = null;
        next = null;
        run = new RunSim();
     ...
     public ThreadModel(int cores, double tsim, int numEvents, int maxBuffer) throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay {
        prev = null;
        next = null;
