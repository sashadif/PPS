...
public class OutputSim extends PetriSim {
    ...
    public OutputSim(int numEvents) throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay{ 
        super(NetLibrary.CreateNetOutput(numEvents)); 
        next = null;
    }
    
    public OutputSim(int cores, int numEvents) throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay{ 
