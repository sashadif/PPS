...
public class RunSim extends PetriSim {
    ...
    public RunSim() throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay {
    ...
    public RunSim(int cores) throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay {
