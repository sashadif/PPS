...
public class WaitSim extends PetriSim {
    ...
    public WaitSim(int id) throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay {
        super(NetLibrary.CreateNetWait());
        this.id = id;

    }
    
     public WaitSim(int cores, int id) throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay {
